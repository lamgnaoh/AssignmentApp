...
public static class ModelBuilderExtensions
{
    public static void Seed(this ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Class>().HasData(
            new Class() { ClassId = 1, Name = "project 20213" },
            new Class() { ClassId = 2, Name = "Lap trinh .NET Core" }
        );
        ...
        modelBuilder.Entity<Assignment>().HasData(
            new Assignment()
            {
                AssignmentId = 1, ClassId = 1, CreateAt = DateTime.Now, DueTo = DateTime.Parse("08/09/2022 23:30:00"),
                Title = "Báo cáo tuần 1", Content = "Nộp báo cáo tuần 1 "
            },
            new Assignment()
            {
                AssignmentId = 2, ClassId = 2, CreateAt = DateTime.Now, DueTo = DateTime.Parse("09/09/2022 23:30:00"),
